...
const PARTNER_TYPES = [
  {
    ...
    color: 'text-[#378ADD]', bg: 'bg-blue-50', border: 'border-blue-200',
  },
  {
    ...
    color: 'text-[#F37321]', bg: 'bg-orange-50', border: 'border-orange-200',
  },
  {
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="bg-gradient-to-br from-[#378ADD] via-[#3B82F6] to-[#60A5FA] text-white py-24 px-4 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-heading text-5xl md:text-6xl font-bold mb-6 leading-tight">
            Let&apos;s Build a <span className="text-[#F37321]">Skilled Nigeria</span> Together
          </h1>
          ...
          <Link href="/contact" className="inline-flex items-center gap-2 bg-[#F37321] text-white font-bold px-8 py-4 rounded-2xl text-lg mt-8
      ...
      <section className="py-20 bg-[#EBF4FF]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="font-heading text-4xl font-bold text-[#1E4F8A] mb-4">Partnership Models</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            {PARTNER_TYPES.map(({ Icon, title, desc, benefits, color, bg, border }) => (
              <div key={title} className={`bg-white border-[3px] ${border} rounded-3xl p-8 shadow-[0_6px_0_rgba(55,138,221,0.08)] hover:-translate-y-1 transition-all duration-200`}>
                <div className={`w-14 h-14 ${bg} rounded-2xl flex items-center justify-center mb-5`}>
                  <Icon className={`w-7 h-7 ${color}`} />
                </div>
                <h3 className="font-heading text-2xl font-bold text-[#1E4F8A] mb-3">{title}</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-heading text-4xl font-bold text-[#1E4F8A] mb-4">Trusted by Leading Organisations</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {CURRENT_PARTNERS.map(p => (
              <div key={p} className="bg-[#EBF4FF] border-[2px] border-blue-100 rounded-2xl px-6 py-5 font-heading font-semibold text-[#1E4F8A] text-sm">
                {p}
              </div>
            ))}
          </div>
          <div className="mt-12">
            <Link href="/contact" className="inline-flex items-center gap-2 bg-[#378ADD] text-white font-bold px-8 py-4 rounded-2xl text-lg
              border-[3px] border-blue-800/20 shadow-[0_6px_0_rgba(55,138,221,0.3)]
              hover:shadow-[0_2px_0_rgba(55,138,221,0.3)] hover:translate-y-1 transition-all duration-150">
