    ...
    <>
      ...
      <div className="min-h-screen bg-[#EBF4FF]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-[#1E4F8A]">Job Applicants</h1>
          ...
          {!employerId && !authError && (
            <div className="bg-white rounded-2xl border border-blue-100 p-16 text-center">
              ...
              <p className="font-semibold text-[#1E4F8A] mb-2">Sign in as an employer</p>
          ...
          {employerId && jobs.length === 0 && (
            <div className="bg-white rounded-2xl border border-blue-100 p-16 text-center">
              ...
              <p className="font-semibold text-[#1E4F8A] mb-2">No job listings yet</p>
              <p className="text-sm text-gray-500 mb-4">
                    ...
                    {jobs.map(j => (
                      <Link key={j.id}
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-[#1E4F8A] truncate">{j.title}</p>
              ...
              <div className="lg:col-span-3">
                {activeJob && (
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <h2 className="font-bold text-[#1E4F8A]">{activeJob.title}</h2>
                ...
                {applications.length === 0 ? (
                  <div className="bg-white rounded-2xl border border-blue-100 p-12 text-center">
                    ...
                    <p className="font-semibold text-[#1E4F8A] mb-1">No applications yet</p>
                          ...
                          <div className="flex flex-col md:flex-row md:items-start gap-4">
                            ...
                            <div className="relative shrink-0">
                              {applicant?.avatar_url ? (
                                ...
                                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-xl font-bold border-2 border-blue-100">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex flex-wrap items-center gap-2 mb-1">
                                <h3 className="font-bold text-[#1E4F8A]">
