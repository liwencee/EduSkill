...
const FEATURED_COURSES = [
  ...
  { title: 'Coding Basics for Beginners', category: 'Tech',         weeks: 6, students: '1.8K', free: false, slug: 'coding-basics',              color: 'bg-blue-100', text: 'text-blue-700' },
  ...
  return (
    <div className="min-h-screen bg-[#EBF4FF]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Welcome Banner */}
        <div className="bg-gradient-to-r from-[#378ADD] to-[#60A5FA] rounded-2xl p-6 mb-8 text-white relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <Link href="/skillup/courses"
              className="inline-flex items-center gap-2 mt-4 bg-[#F37321] text-white text-sm font-bold px-4 py-2 rounded-xl hover:bg-orange-600 transition-colors">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            { label: 'Courses Enrolled',    value: 0, icon: BookOpen,  bg: 'bg-blue-50',  color: 'text-[#378ADD]' },
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-blue-100 shadow-sm p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="font-bold text-[#1E4F8A] text-lg">Continue Learning</h2>
                <Link href="/skillup" className="text-sm text-[#378ADD] hover:underline flex items-center gap-1">
                  All courses <ChevronRight className="w-3 h-3" />
                </Link>
              </div>
              <div className="text-center py-10">
                <div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center mx-auto mb-3">
                  <BookOpen className="w-8 h-8 text-[#378ADD] opacity-50" />
                </div>
                <p className="font-semibold text-[#1E4F8A] mb-1">No courses yet</p>
            ...
            <div className="bg-white rounded-2xl border border-blue-100 shadow-sm p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="font-bold text-[#1E4F8A] text-lg">Recommended for You</h2>
                <Link href="/skillup/courses" className="text-sm text-[#378ADD] hover:underline">See all</Link>
              </div>
              <div className="space-y-3">
                {FEATURED_COURSES.map(c => (
                  <Link key={c.slug} href={`/skillup/courses/${c.slug}`}
                    className="flex items-center gap-4 p-3 rounded-xl hover:bg-blue-50 transition-colors border border-transparent hover:border-blue-100">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-blue-100 shadow-sm p-6">
              ...
              <div className="space-y-2">
                {[
                  { href: '/skillup/courses',         icon: BookOpen,   label: 'Browse Courses',    bg: 'bg-blue-50',  color: 'text-[#378ADD]' },
                  { href: '/opportunity-hub/jobs',    icon: Briefcase,  label: 'Find Jobs',         bg: 'bg-orange-50',  color: 'text-[#F37321]' },
            ...
            <div className="bg-white rounded-2xl border border-blue-100 shadow-sm p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="font-bold text-[#1E4F8A]">My Certificates</h2>
            ...
            {/* Learning Tip */}
            <div className="bg-gradient-to-br from-[#378ADD] to-[#60A5FA] rounded-2xl p-5 text-white">
