      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-[#E0DDD5] shadow-sm p-8 text-center">
          ...
          <div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center mx-auto mb-5">
            <Mail className="w-8 h-8 text-[#378ADD]" />
          </div>
          ...
          {/* Steps */}
          <div className="text-left bg-[#EBF4FF] rounded-xl p-4 mb-6 space-y-3">
            {[
              ...
              <div key={s.step} className="flex items-center gap-3">
                <span className="w-6 h-6 rounded-full bg-[#378ADD] text-white text-xs font-bold flex items-center justify-center shrink-0">
                  {s.step}
                </span>
                <span className="text-sm text-[#1E4F8A]">{s.text}</span>
              </div>
            ))}
          </div>
          ...
          <p className="text-xs text-brand-inkLight mb-6">
            ...
            <span className="text-[#378ADD] font-semibold">wait a few minutes</span>.
            Emails can take up to 5 minutes to arrive.
          </p>

          <div className="space-y-3">
            <Link href="/auth/login"
              className="w-full inline-flex items-center justify-center gap-2 bg-[#378ADD] text-white font-bold py-3 rounded-xl hover:bg-blue-700 transition-colors">
              Go to Login <ArrowRight className="w-4 h-4" />
            </Link>
            <Link href="/auth/signup"
              className="w-full inline-flex items-center justify-center gap-2 border border-[#E0DDD5] text-brand-inkMid font-semibold py-3 rounded-xl hover:bg-[#EBF4FF] transition-colors text-sm">
        ...
        <p className="text-center text-xs text-brand-inkLight mt-6">
          Need help?{' '}
          <Link href="/whatsapp-support" className="text-[#378ADD] hover:underline font-medium">
